 ...
 * Adds a class to the body to signal that the page has loaded and is ready to
 * be shown without layout shifts.
 *
 * @param {string} [target='#app-loader'] - CSS selector for the loader element.
 * Defaults to '#app-loader'.
 */
